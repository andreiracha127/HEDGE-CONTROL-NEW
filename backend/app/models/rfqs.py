...
class RFQ(Base):
    ...
    intent: Mapped[RFQIntent] = mapped_column(
        Enum(RFQIntent, name="rfq_intent", values_callable=_enum_values),
        nullable=False,
    )
    ...
    direction: Mapped[RFQDirection] = mapped_column(
        Enum(RFQDirection, name="rfq_direction", values_callable=_enum_values),
        nullable=False,
    )
    ...
    state: Mapped[RFQState] = mapped_column(
        Enum(RFQState, name="rfq_state", values_callable=_enum_values),
        nullable=False,
    )
