...
Add to `backend/app/core/rate_limit.py` beside the existing rate-limit constants. At the cited baseline, insert this after `RATE_LIMIT_READ` and before the `limiter = Limiter(...)` definition:
